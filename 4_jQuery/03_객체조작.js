...
// contect3의 내용(텍스트)을 content4의 추가
...
// $(A).prepend(B) : A 요소의 자식 요소로 c 요소를 앞부분에 추가
...
$(".item").hover(
  /*
  (event) => {
    console.log("event 1 : " + event.type); // mouseenter
    console.log(event.target);
    $(event.target).addClass("bg-hotpink");
  },
  (event) => {
    console.log("event 2 : " + event.type); // mouseleave
